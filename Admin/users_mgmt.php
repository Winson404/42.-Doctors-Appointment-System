<title>Doctors appointment system | Manage Patient</title>
<?php 
        ...
        <form action="process_save.php" method="POST" enctype="multipart/form-data">
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-primary float-right btn-sm" name="create_user" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
              <a href="users.php" class="btn btn-secondary float-right btn-sm mr-1"><i class="fa-solid fa-backward"></i> Back</a>
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="col-md-12">
        <form action="process_update.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-primary float-right btn-sm " name="update_user" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
              <a href="users.php" class="btn btn-secondary btn-sm float-right mr-1"><i class="fa-solid fa-backward"></i> Back</a>
            </div>
          </div>
        </form>
      </div>
