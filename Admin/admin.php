          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header p-2">
                <a href="admin_mgmt.php?page=create" class="btn btn-sm bg-primary ml-2 <?= ($type_logged_in == 3) ? '' : 'd-none' ?>"><i class="fa-sharp fa-solid fa-square-plus"></i> New Doctor</a>
                  ...
                  <tbody id="users_data">
                    <?php
                      ...
                      if($type_logged_in == 3) {
                        ...
                        $sql = mysqli_query($conn, "SELECT * FROM users WHERE user_type = 2 AND user_Id != $id");
                      }
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-success btn-sm" href="admin_mgmt.php?page=<?php echo $row['user_Id']; ?>"><i class="fas fa-pencil-alt"></i> Edit</a>
