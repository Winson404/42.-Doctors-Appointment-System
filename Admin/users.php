        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header p-2">
              <a href="users_mgmt.php?page=create" class="btn btn-sm bg-primary ml-2"><i class="fa-sharp fa-solid fa-square-plus"></i> New Patient</a>
                ...
                <tbody id="users_data">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-success btn-sm" href="users_mgmt.php?page=<?php echo $row['user_Id']; ?>"><i class="fas fa-pencil-alt"></i> Edit</a>
