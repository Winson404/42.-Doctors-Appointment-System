    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container">
          <div class="row">
            <div class="col-md-4">
              <img src="../images-users/<?php echo $row['image']; ?>" alt="Patient Photo" class="img-fluid rounded">
            </div>
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
      ...
      <div class="modal-footer">
        ...
        <a href="users_mgmt.php?page=<?php echo $row['user_Id']; ?>" class="btn btn-success float-right btn-sm"><i class="fas fa-pencil-alt"></i> Edit</a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="delete<?php echo $row['user_Id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user-large"></i> Delete Patient</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true"><i class="fa-solid fa-circle-xmark"></i></span>
        </button>
      </div>
      <div class="modal-body">
        <form action="process_delete.php" method="POST">
          ...
          <h6 class="text-center">Delete patient record?</h6>
        </div>
        <div class="modal-footer alert-light">
          <button type="button" class="btn bg-secondary btn-sm" data-dismiss="modal"><i class="fa-solid fa-ban"></i> Cancel</button>
          <button type="submit" class="btn bg-danger btn-sm" name="delete_user"><i class="fas fa-trash"></i> Delete</button>
        </div>
      </form>
    </div>
  </div>
