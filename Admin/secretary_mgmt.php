<title>Doctors appointment system | Manage Secretary</title>
<?php 
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Secretary Add</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <form action="process_save.php" method="POST" enctype="multipart/form-data">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-10 col-md-10 col-sm-9 col-12">
                  <div class="form-group">
                    <span class="text-dark"><b>Secretary's photo</b></span>
                    <div class="input-group">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-primary float-right btn-sm" name="create_secretary" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
              <a href="secretary.php" class="btn btn-secondary float-right btn-sm mr-1"><i class="fa-solid fa-backward"></i> Back</a>
            </div>
          </div>
        </form>
      </div>
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
            <li class="breadcrumb-item active">Secretary Update</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <form action="process_update.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-primary float-right btn-sm " name="update_secretary" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
              <a href="secretary.php" class="btn btn-secondary btn-sm float-right mr-1"><i class="fa-solid fa-backward"></i> Back</a>
            </div>
          </div>
        </form>
      </div>
