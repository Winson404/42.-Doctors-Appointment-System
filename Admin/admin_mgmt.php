<title>Doctors appointment system | Manage Doctor</title>
<?php 
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-6 col col-md-6 col-sm-6 col-12" id="specializationField">
                    <div class="form-group">
                ...
                <div class="col-lg-6 col col-md-6 col-sm-6 col-12" id="clinicFields">
                    <div class="form-group">
                        <span class="text-dark"><b>Clinic name</b></span>
                        <input type="text" class="form-control" placeholder="Clinic name" name="clinic_name" required>
                    </div>
                </div>
                <div class="col-lg-12 col col-md-12 col-sm-12 col-12" id="clinicServicesField">
                    <div class="form-group">
                        <span class="text-dark"><b>Clinic services</b></span>
                        <textarea class="form-control" placeholder="Clinic services" name="clinic_services" id="" cols="30" rows="2" required></textarea>
                    </div>
                </div>
                <div class="col-lg-10 col-md-10 col-sm-9 col-12">
                  <div class="form-group">
                    <span class="text-dark"><b>Doctor's photo</b></span>
                    <div class="input-group">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-primary float-right btn-sm" name="create_admin" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
      ...
      <div class="col-md-12">
        <form action="process_update.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-6 col col-md-6 col-sm-6 col-12" id="specializationField">
                    <div class="form-group">
                        <span class="text-dark"><b>Specialization</b></span>
                        <input type="text" class="form-control" placeholder="Specialization" name="specialization" value="<?php echo $row['specialization']; ?>" required>
                    </div>
                </div>
                <div class="col-lg-6 col col-md-6 col-sm-6 col-12" id="clinicFields">
                    <div class="form-group">
                        <span class="text-dark"><b>Clinic name</b></span>
                        <input type="text" class="form-control" placeholder="Clinic name" name="clinic_name" value="<?php echo $row['clinic_name']; ?>" required>
                    </div>
                </div>
                <div class="col-lg-12 col col-md-12 col-sm-12 col-12" id="clinicServicesField">
                    <div class="form-group">
                        <span class="text-dark"><b>Clinic services</b></span>
                        <textarea class="form-control" placeholder="Clinic services" name="clinic_services" id="" cols="30" rows="2" required><?php echo $row['clinic_services']; ?></textarea>
                    </div>
                </div>
                <div class="col-lg-10 col-md-10 col-sm-9 col-12">
                  <div class="form-group">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-primary float-right btn-sm " name="update_admin" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
              <a href="admin.php" class="btn btn-secondary float-right btn-sm mr-1"><i class="fa-solid fa-backward"></i> Cancel</a>
            </div>
          </div>
        </form>
