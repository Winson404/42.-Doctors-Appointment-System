  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
                  ...
                  <br>
                  <h5 class="card-title text-primary m-1">Other details</h5>
                  <p class="card-text m-1"><strong>Specialization:</strong> <?php echo ucwords($row['specialization']); ?></p>
                  <p class="card-text m-1"><strong>Clinic name:</strong> <?php echo ucwords($row['clinic_name']); ?></p>
                  <p class="card-text m-1"><strong>Services:</strong> <?php echo ucwords($row['clinic_services']); ?></p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-footer">
        ...
        <a href="admin_mgmt.php?page=<?php echo $row['user_Id']; ?>" class="btn btn-success float-right btn-sm d-none"><i class="fas fa-pencil-alt"></i> Edit</a>
        <?php endif; ?>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="delete<?php echo $row['user_Id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user-large"></i> Delete Doctor</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true"><i class="fa-solid fa-circle-xmark"></i></span>
        </button>
      </div>
      <div class="modal-body">
        <form action="process_delete.php" method="POST">
          ...
          <h6 class="text-center">Delete doctor record?</h6>
        </div>
