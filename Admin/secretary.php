<title>Doctors appointment system | Secretary records</title>
<?php
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Secretary records</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header p-2">
              <a href="secretary_mgmt.php?page=create" class="btn btn-sm bg-primary ml-2"><i class="fa-sharp fa-solid fa-square-plus"></i> New Secretary</a>
                ...
                <tbody id="users_data">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-success btn-sm" href="secretary_mgmt.php?page=<?php echo $row['user_Id']; ?>"><i class="fas fa-pencil-alt"></i> Edit</a>
                  ...
                  <?php include 'secretary_delete.php'; } ?>
                </tbody>
              </table>
            </div>
          </div>
